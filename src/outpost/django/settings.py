...
CORS_ALLOW_METHODS = default_methods + ("START", "STOP", "END", "CANCEL", "DISCARD")
...
LOGGING = {
    ...
    "loggers": {
        "root": {"level": "INFO", "handlers": ["console", "graypy"]},
        "django": {"handlers": ["console"], "level": "INFO"},
        "django.request": {"handlers": ["graypy"], "level": "ERROR", "propagate": True},
        "rules": {"handlers": ["console"], "level": "INFO"},
        __package__: {"handlers": ["console", "mail_admins"], "level": "INFO"},
    },
}
